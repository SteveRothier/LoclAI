...
import { MaxPredictTokensSelect } from "@/components/settings/MaxPredictTokensSelect";
...
export function SettingsContent({ section }: SettingsContentProps) {
  ...
  const sectionContent = (() => {
        ...
        <>
          ...
          <div className="space-y-6">
            <SettingsGroup title="Connexion">
              <SettingsRow label="URL endpoint" align="top">
            ...
            <SettingsGroup title="Contexte">
              <SettingsRow label="Messages max. dans le contexte">
                <Input
                  type="number"
                  min={4}
                  max={200}
              ...
              <SettingsRow label="Tokens max. par réponse">
                <MaxPredictTokensSelect
                  value={settings.maxPredictTokens}
                  onChange={(maxPredictTokens) => void update({ maxPredictTokens })}
                />
              </SettingsRow>
              <SettingsRow
    ...
    if (section === "assistants") {
      return (
        <>
          <SettingsSectionHeader title="Assistants" />
          <PersonasEditor
    ...
    if (section === "models") {
      return (
        <>
          <SettingsSectionHeader title="Modèles" />
    ...
    if (section === "data") {
      return (
        <>
          <SettingsSectionHeader title="Données" />
          <SettingsGroup>
            <SettingsRow label="Exporter">
              <Button type="button" variant="outline" onClick={() => void handleExport()}>
                <Download className="size-4" />
                Exporter JSON
              </Button>
            </SettingsRow>
            <SettingsRow label="Importer">
              <div className="space-y-2">
                <Button
                  type="button"
                  variant="outline"
    ...
    return (
      <>
        <SettingsSectionHeader title="Avancé" />
